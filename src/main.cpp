    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //   of the road.
          auto sensor_fusion = j[1]["sensor_fusion"];  // other cars
         ...
         //vector<double> next_y_vals;
           ...
           */
          //  Preventing collitions -- if previous path does contain points, assume car is at end position of previous path
          ...
          // Prediction : Analysing other cars positions.
            ...
            // Marking coordinates to local car coordinates.
